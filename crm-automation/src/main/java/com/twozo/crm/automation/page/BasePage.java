...
public abstract class BasePage {
    ...
    protected static final Map<String, String> CRM_TEXT_REGISTRY = ConfigFileReader.get("Text.properties");
    ...
    protected final void chooseDate(final String fieldName, final String date) {
        ...
        while (!getText(findByXpath(CRM_LOCATOR_REGISTRY.get("crm.calendar.month.and.year"))).contains(Month.getMonthName(Integer.parseInt(part[2])))) {
