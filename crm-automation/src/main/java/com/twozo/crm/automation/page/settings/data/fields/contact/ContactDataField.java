package com.twozo.crm.automation.page.settings.data.fields.contact;
...
public class ContactDataField extends AbstractDataField {
    ...
    private SystemField getFirstNameField() {
        ...
        return new SystemField(
                getNonDraggableElement(firstName),
                getFieldName(firstName),
                getFieldType(firstName, ContactField.FIRST_NAME.getFieldType()),
    ...
    private SystemField getLastNameField() {
        ...
        return new SystemField(
                getNonDraggableElement(lastName),
                getFieldName(lastName),
                getFieldType(lastName, ContactField.LAST_NAME.getFieldType()),
    ...
    private SystemField getEmailsField() {
        ...
        return new SystemField(
                getNonDraggableElement(emails),
                getFieldName(emails),
                getFieldType(emails, ContactField.EMAILS.getFieldType()),
                isSelected(getAddViewCheckboxOf(emails)),
                isSelected(getRequiredCheckboxOf(emails)),
                null
        );
    }
    ...
    private SystemField getPhonesField() {
        ...
        return new SystemField(
                getNonDraggableElement(phones),
                getFieldName(phones),
                getFieldType(phones, ContactField.PHONES.getFieldType()),
    ...
    private SystemField getCompanyField() {
        ...
        return new SystemField(
                getNonDraggableElement(company),
                getFieldName(company),
                getFieldType(company, ContactField.COMPANY.getFieldType()),
    ...
    private SystemField getDesignationField() {
        ...
        return new SystemField(
                getNonDraggableElement(designation),
                getFieldName(designation),
                getFieldType(designation, ContactField.DESIGNATION.getFieldType()),
    ...
    private SystemField getSalesOwnerField() {
        ...
        return new SystemField(
                getNonDraggableElement(salesOwner),
                getFieldName(salesOwner),
                getFieldType(salesOwner, ContactField.SALES_OWNER.getFieldType()),
    ...
    private SystemField getFacebookField() {
        ...
        return new SystemField(
                getNonDraggableElement(facebook),
                getFieldName(facebook),
                getFieldType(facebook, ContactField.FACEBOOK.getFieldType()),
                isSelected(getAddViewCheckboxOf(facebook)),
                !isSelected(getRequiredCheckboxOf(facebook)),
                null
        );
    }
    ...
    private SystemField getLinkedInField() {
        ...
        return new SystemField(
                getNonDraggableElement(linkedIn),
                getFieldName(linkedIn),
                getFieldType(linkedIn, ContactField.LINKED_IN.getFieldType()),
                isSelected(getAddViewCheckboxOf(linkedIn)),
                !isSelected(getRequiredCheckboxOf(linkedIn)),
                null
        );
    }
    ...
    public boolean checkChoicesForSource() {
        return areChoicesPresent(List.of( "Web",
                "Organic Search",
                "Email",
                "Phone",
                "Chat",
    ...
    public boolean checkChoicesForTimeZone() {
        return areChoicesPresent(List.of("(UTC+00:00) Africa/Abidjan",
    ...
    public boolean checkChoicesForSubscriptionStatus() {
        return areChoicesPresent(List.of("Subscribed", "Unsubscribed", "Not Subscribed", "Reported as spam", "Bounced"));
    }

    public boolean checkChoicesForSubscriptionTypes() {
        return areChoicesPresent(List.of("Newsletter", "Promotional", "Product updates", "Conference and events",
                "Non marketing emails from our company"));
    }

    public boolean checkChoicesForLostReason() {
        return areChoicesPresent(List.of("Junk Lead", "Not able to reach", "Not interested", "Budget",
                "Lost of competitor"));
    }

    public boolean checkChoicesForUnsubscribeReason() {
        return areChoicesPresent(List.of("I no longer want to receive emails from you", "I receive too many emails from you",
    ...
    public List<String> getAllFields() {
        return ContactField.getAllFields();
    }
    ...
    public Collection<String> getFieldsForSummary() {
        return getFieldsForSummary(List.of(ContactField.FIRST_NAME.getName(),
