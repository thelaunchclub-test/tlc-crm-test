package com.twozo.crm.automation.page.settings.data.fields.company;
...
public class CompanyDataField extends AbstractDataField {
    ...
    public String getNameDiv() {
        return getFieldBlock(CompanyField.NAME.getName());
    }
    ...
    private SystemField getWebsiteField() {
        ...
        return new SystemField(getNonDraggableElement(website),
                getFieldName(website),
                getFieldType(website, CompanyField.WEBSITE.getFieldType()),
    ...
    private SystemField getSalesOwnerField() {
        ...
        return new SystemField(getNonDraggableElement(salesOwner),
    ...
    private SystemField getAddressField() {
        ...
        return new SystemField(getNonDraggableElement(address),
                getFieldName(address),
                getFieldType(address, CompanyField.ADDRESS.getFieldType()),
    ...
    public boolean checkChoicesForOrganizationStatus() {
        return areChoicesPresent(List.of("Acquired", "Active", "Market Failed", "Project Cancelled", "Shutdown"));
    }
    ...
    public boolean checkChoicesForIndustryType() {
        final List<String> industries = List.of(
                "Accounting",
                "Advertising",
                "Aerospace",
                "Agriculture",
    ...
    public boolean checkChoicesForBusinessType() {
        final List<String> businessTypes = List.of(
                "Analyst",
                "Competitor",
                "Customer",
                "Distributor",
    ...
    public List<String> getAllFields() {
        return CompanyField.getAllFields();
    }
    ...
    public Collection<String> getFieldsForSummary() {
        return getFieldsForSummary(List.of("Name", "Website"));
    }
}
