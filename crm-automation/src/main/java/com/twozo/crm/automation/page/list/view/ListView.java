package com.twozo.crm.automation.page.list.view;
...
public class ListView extends BasePage {
    ...
    public String getFieldData(final int listNumber, final int fieldPosition) {
        ...
        return getText(findByXpath(format(String.format(CRM_LOCATOR_REGISTRY.get("crm.list.view.specific.row"), listNumber),
