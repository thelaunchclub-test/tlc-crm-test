package com.twozo.crm.automation.page.settings.data.fields.deal.field;
...
public enum DealField implements Field {
    ...
    public static Collection<String> getDefaultFields() {
        return Arrays.stream(new DealField[]{
                        TITLE, PIPELINE, STAGE, WON_REASON, LOST_REASON, DEAL_CLOSED_ON,
                        PRIMARY_CONTACT, RELATED_CONTACTS, COMPANY, DEAL_VALUE,
                        SALES_OWNER, PRODUCT_QUANTITY
                })
    ...
    public static List<String> getAllFields() {
        return Arrays.stream(DealField.values())
                .map(DealField::getName)
                .collect(Collectors.toList());
    }
}
