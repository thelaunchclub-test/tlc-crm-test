...
import com.twozo.crm.automation.page.company.CompanyAddForm;
import com.twozo.crm.automation.page.company.CompanyForm;
...
public class AddCompanyTest extends AddFormTest {
    ...
    public void fill(final Object object) throws IllegalAccessException {
        CompanyDataField.getInstance(automationDriver).setFieldsAddViewEnabled(getFieldsForUpdate(getForm(object)));
