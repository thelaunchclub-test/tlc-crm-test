//package com.twozo.validateActivityStatusByDate.settings.data.fields;
//
...
//import com.twozo.validateActivityStatusByDate.TestDataProvider;
...
////        automationDriver.getWebWindowHandler().maximize();
////        Contact.getInstance(automationDriver).addContactToActivity().createContact("a", "a@gmail.com", "9876543211");
////    }
//
//    @BeforeMethod
//    public void before() {
