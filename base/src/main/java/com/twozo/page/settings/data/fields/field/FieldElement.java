...
public class FieldElement {
    ...
    public static final String DRAGGABLE = "//*[@draggable='false']";
    ...
    public static final String DEPENDABLE_BLOCK = "//*[@class='css-11x1d9z']//*[text()='%s']/ancestor::div[@class='css-11x1d9z']";
