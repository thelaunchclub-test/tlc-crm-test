...
public class FieldElement {
    ...
    public static final String FIELD_BLOCK = "//*[@class='MuiBox-root twozo-css-prefix-19idom']//*[text()='%s']/ancestor::div[@class='MuiBox-root twozo-css-prefix-19idom']";
    public static final String DEPENDABLE_BLOCK = "//*[@class='MuiBox-root twozo-css-prefix-19idom']//*[text()='%s']/ancestor::div[@class='MuiStack-root twozo-css-prefix-bsk3e7']";
    public static final String BLOCK = "(//*[@class='MuiBox-root twozo-css-prefix-19idom'])[%d]";
    public static final String MENU_BLOCK = "//*[@class='MuiStack-root twozo-css-prefix-l88ic']//*[text()='%s']//ancestor::div[@class='MuiStack-root twozo-css-prefix-l88ic']";
    public static final String CUSTOM_FIELD_NAME = "(//*[@type='text'])[2]";
    public static final String SYSTEM_FIELD_SEARCH_RESULT = "//*[@class='MuiBox-root twozo-css-prefix-1x36n8t']";
    public static final String CHECKBOX = "//*[@type='checkbox'])";
    public static final String SPECIFIC_FIELD_COLUMN_SETTINGS_CHECKBOX = "//*[@data-rbd-droppable-id='tableHead_items']//*[text()='%s']//ancestor::div[@class='MuiStack-root twozo-css-prefix-csffzd']";
