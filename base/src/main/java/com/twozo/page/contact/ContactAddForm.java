...
public class ContactAddForm extends AddForm {
    ...
    private WebPageElement getEmailId(final int position) {
        return findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.email.field"), position));
    }

    private WebPageElement getEmailType(final int position) {
        return findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.email.type"), position));

    }

    private WebPageElement getPhone(final int position) {
        return findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.phone.field"), position));
    }

    private WebPageElement getPhoneType(final int position) {
        return findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.phone.type"), position));
...
//    }
    ...
    private WebPageElement getAddEmailButton() {
        return findByXpath(LOCATORS.get("crm.add.form.contact.add.email"));
    }

    private WebPageElement getAddPhoneButton() {
        return findByXpath(LOCATORS.get("crm.add.form.contact.add.phone"));
    }
    ...
    public void setCompany(final String company) {
        ...
        try {
            ...
            if (isDisplayed(findByXpath(LOCATORS.get("crm.add.form.contact.add.company.button")))) {
                click(findByXpath(LOCATORS.get("crm.add.form.contact.add.company.button")));
            }
    ...
    public void setDepartment() {
        send(getDesignation(), faker.job().title());
    }
...
//        send(getAddressLine1(), faker.address().buildingNumber());
//        send(getAddressLine2(), faker.address().streetAddress());
//        send(getCity(), faker.address().city());
//        send(getState(), faker.address().state());
//        click(getCountry());
//        dropdown(faker.address().country());
//        send(getPincode(), faker.address().zipCode());
//    }
    ...
    public boolean verifyDefaultTypeOfEmail() {
        return Objects.equals(getText(findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.email.type"), 1))), "Work");
    }

    public boolean verifyDefaultTypeOfPhone() {
        return Objects.equals(getText(findByXpath(String.format(LOCATORS.get("crm.add.form.contact.specific.phone.type"), 1))), "Work");
    }

    public boolean verifyDefaultLifecycleStage() {
        return Objects.equals(getText(findByXpath(String.format(LOCATORS.get("crm.add.form.dropdown.field"),
    ...
    public boolean verifySystemFieldsDisplayedInAddForm() {
        ...
        for (final WebPageElement webPageElement : findElementsByXpath(LOCATORS.get("crm.add.form.fields"))) {
