package com.twozo.crm.automation.base.page.settings.data.fields.contact;
...
public class ContactDataField {
    ...
    private ContactDataField(final WebAutomationDriver webAutomationDriver) {
    ...
    public String getFirstNameDiv() {
        return getFieldBlock(ContactField.FIRST_NAME.getName());
    }

    public String getLastNameDiv() {
        return getFieldBlock(ContactField.LAST_NAME.getName());
    }

    public String getEmailDiv() {
        return getFieldBlock(ContactField.EMAILS.getName());
    }

    public String getPhonesDiv() {
        return getFieldBlock(ContactField.PHONES.getName());
    }

    public String getCompanyDiv() {
        return getFieldBlock(ContactField.COMPANY.getName());
    }

    public String getDesignationDiv() {
        return getFieldBlock(ContactField.DESIGNATION.getName());
    }

    public String getSalesOwnerDiv() {
        return getFieldBlock(ContactField.SALES_OWNER.getName());
    }

    public String getFacebookDiv() {
        return getFieldBlock(ContactField.FACEBOOK.getName());
    }

    public String getLinkedInDiv() {
        return getFieldBlock(ContactField.LINKED_IN.getName());
    }
    ...
    private SystemField getLastNameField() {
        ...
        return new SystemField(
                ...
                isSelected(getAddViewCheckboxOf(lastName)),
                !isSelected(getRequiredCheckboxOf(lastName)),
                null
        );
    }
    ...
    private SystemField getEmailsField() {
        ...
        return new SystemField(
                ...
                isSelected(getAddViewCheckboxOf(email)),
                isSelected(getRequiredCheckboxOf(email)),
                null
        );
    }
    ...
    private SystemField getPhonesField() {
        ...
        return new SystemField(
                ...
                isSelected(getAddViewCheckboxOf(phones)),
                isSelected(getRequiredCheckboxOf(phones)),
                null
        );
    }
    ...
    private SystemField getDesignationField() {
        ...
        return new SystemField(
                ...
                isSelected(getAddViewCheckboxOf(designation)),
                !isSelected(getRequiredCheckboxOf(designation)),
                null
        );
    }
    ...
    private SystemField getFacebookField() {
        final String facebookField = ContactField.FACEBOOK.getName();

        return new SystemField(
                getDraggableElement(ContactField.FACEBOOK),
                getFieldName(ContactField.FACEBOOK),
                getFieldType(ContactField.FACEBOOK),
                isSelected(getAddViewCheckboxOf(facebookField)),
                !isSelected(getRequiredCheckboxOf(facebookField)),
                null
        );
    }

    private SystemField getLinkedInField() {
        final String linkedInField = ContactField.LINKED_IN.getName();

        return new SystemField(
                getDraggableElement(ContactField.LINKED_IN),
                getFieldName(ContactField.LINKED_IN),
                getFieldType(ContactField.LINKED_IN),
                isSelected(getAddViewCheckboxOf(linkedInField)),
                !isSelected(getRequiredCheckboxOf(linkedInField)),
                null
        );
    }
    ...
    public boolean emailOrPhoneShouldBeRequired() {
        return isSelected(findByXpath(getPathOfSpecificCheckbox(getEmailDiv(), FieldAttribute.REQUIRED_CHECKBOX))) ||
                isSelected(findByXpath(getPathOfSpecificCheckbox(getPhonesDiv(), FieldAttribute.REQUIRED_CHECKBOX)));
    }
    ...
    public boolean checkChoicesForSource() {
        ...
        return areAllChoicesPresent(sources);
    }
    ...
    public boolean checkChoicesForTimeZone() {
        final String[] timeZones = {
                ...
                "(UTC+12:00) Pacific/Rarotonga",
                "(UTC+12:00) Pacific/Saipan",
                "(UTC+13:00) Pacific/Tarawa",
                "(UTC+12:00) Pacific/Tongatapu",
                "(UTC+11:00) Pacific/Wake",
        ...
        return areAllChoicesPresent(timeZones);
    }
    ...
    public boolean checkSubscriptionStatus() {
        ...
        if (!isDependableFieldElementDisplayed(subscriptionStatus, FieldAttribute.DRAGGABLE)) {
            return false;
        }

        if (!isDependableFieldElementDisplayed(subscriptionStatus, FieldTypePath.DROPDOWN)) {
            return false;
        }

        click(findByXpath(formatTwoStrings(getDependableBlock(subscriptionStatus), fiveChoices)));
        ...
        if (!isDependableFieldElementDisplayed(subscriptionTypes, FieldTypePath.MULTI_SELECT)) {
            return false;
        }
        click(findByXpath(formatTwoStrings(getDependableBlock(subscriptionTypes), fiveChoices)));
        ...
        if (!isDependableFieldElementDisplayed(unsubscribeReason, FieldTypePath.DROPDOWN)) {
            return false;
        }
        click(findByXpath(formatTwoStrings(getDependableBlock(unsubscribeReason), fiveChoices)));
        if (!checkChoicesForUnsubscribeReason()) {
            return false;
        }
        click(findByXpath(CRM_LOCATOR_REGISTRY.get("body")));

        return isDependableFieldElementDisplayed(ContactField.OTHER_UNSUBSCRIBE_REASON.getName(), FieldTypePath.TEXT);
    }
    ...
    public boolean checkLifecycleStage() {
        ...
        if (!isDependableFieldElementDisplayed(lifecycleStage, FieldAttribute.DRAGGABLE)) {
            return false;
        }

        if (!isDependableFieldElementDisplayed(lifecycleStage, FieldTypePath.DROPDOWN)) {
            return false;
        }

        if (!isFieldElementDisplayed(lifecycleStage, XPathBuilder.getXPathByText("3"))) {
            return false;
        }

        if (!isDependableFieldElementDisplayed(lifecycleStatus, FieldTypePath.DROPDOWN)) {
            return false;
        }

        if (!isFieldElementDisplayed(lifecycleStatus, XPathBuilder.getXPathByText("0"))) {
            return false;
        }

        if (!isDependableFieldElementDisplayed(lostReason, FieldTypePath.DROPDOWN)) {
            return false;
        }

        if (!isFieldElementDisplayed(lostReason, XPathBuilder.getXPathByText("5"))) {
            return false;
        }
        click(findByXpath(formatTwoStrings(getDependableBlock(lostReason), XPathBuilder.getXPathByText("5"))));
    ...
    public boolean checkSource() {
        ...
        if (!isFieldElementDisplayed(source, FieldAttribute.DRAGGABLE)) {
            return false;
        }

        if (!isFieldElementDisplayed(source, FieldTypePath.DROPDOWN)) {
            return false;
        }
        click(findByXpath(formatTwoStrings(getFieldBlock(source), XPathBuilder.getXPathByText("14"))));
    ...
    public boolean checkTimezone() {
        ...
        if (!isFieldElementDisplayed(timeZone, FieldAttribute.DRAGGABLE)) {
            return false;
        }

        if (!isFieldElementDisplayed(timeZone, FieldTypePath.DROPDOWN)) {
            return false;
        }
        waitTillVisible(getFieldBlock(timeZone));
        click(findByXpath(formatTwoStrings(getFieldBlock(timeZone), XPathBuilder.getXPathByText("100"))));
