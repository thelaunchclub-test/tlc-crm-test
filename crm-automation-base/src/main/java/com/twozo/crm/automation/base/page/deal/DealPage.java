...
import com.twozo.crm.automation.base.page.Filter;
...
public class DealPage extends BasePage {
    ...
    public WebPageElement getListViewButton() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.deal.view.list"));
    }

    public WebPageElement getKanbanViewButton() {
        return findByText(CRM_LOCATOR_REGISTRY.get("crm.deal.view.kanban"));
    }
    ...
    public WebPageElement getAllDealButton() {
        return findByText(CRM_LOCATOR_REGISTRY.get("crm.deal.filter.all.deal"));
    }

    public WebPageElement getImportDealsButton() {
        return findByText(CRM_LOCATOR_REGISTRY.get("crm.deal.button.import.deal"));
    }

    public WebPageElement getAddDealButton() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.deal.button.add.deal"));
    }

    public WebPageElement getContactIcon() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.contact.icon"));
    }

    public WebPageElement getFilterIcon() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.source.filter.icon"));
    }
...
//    }
    ...
    public WebPageElement getManageButton() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.deal.button.manage"));
    }

    public WebPageElement getActivePipeline() {
        return findByXpath(CRM_LOCATOR_REGISTRY.get("crm.deal.pipeline.active"));
    }

    public DealAddForm getAddDeal() {

        if (Objects.isNull(addDeal)) {
            addDeal = DealAddForm.getInstance(getWebAutomationDriver());
    ...
    public KanbanView getKanbanView() {
        ...
        if (Objects.isNull(kanbanView)) {
            kanbanView = KanbanView.getInstance(getWebAutomationDriver());
    ...
    public ForecastView getForecastView() {
        ...
        if (Objects.isNull(addDeal)) {
            forecastView = ForecastView.getInstance(getWebAutomationDriver());
        }
    ...
    public PipelineForm getAddPipeline() {
        if (Objects.isNull(addPipeline)) {
            addPipeline = PipelineForm.getInstance(getWebAutomationDriver());
        }
    ...
    public Filter getFilter() {
        ...
        if (Objects.isNull(filter)) {
            filter = Filter.getInstance(getWebAutomationDriver());
        }
    ...
    public void switchToColumnSettings() {
        waitTillClickable(CRM_LOCATOR_REGISTRY.get("crm.deal.view.list"));
    ...
    public void switchToPipeline() {
        ...
        waitTillClickable(CRM_LOCATOR_REGISTRY.get("crm.deal.button.manage"));
//        try {
//            Thread.sleep(3000);
...
//        }
    ...
    public boolean verifyPipelineChangeInKanbanReflectedInAddDealForm() {
        final String activePipelineXPath = CRM_LOCATOR_REGISTRY.get("crm.deal.pipeline.active");
        ...
        click(getActivePipeline());
        final Collection<WebPageElement> pipelinesAsElement = findElementsByXpath(CRM_LOCATOR_REGISTRY.get("crm.deal.pipelines"));
        ...
        if (!isPipelineChanged) {
            ...
            final PipelineForm pipelineForm = PipelineForm.getInstance(getWebAutomationDriver());
