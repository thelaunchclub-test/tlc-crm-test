package com.twozo.crm.automation.base.page.add.form;
...
public abstract class AddForm extends BasePage {
    ...
    protected static final String INVALID_URL = CRM_LOCATOR_REGISTRY.get("crm.notification.invalid.url");
    ...
    public boolean isInvalidMailNotificationDisplayed() {
        return isDisplayed(findByXpath(INVALID_MAIL_ID));
    }

    public boolean isInvalidURLNotificationDisplayed(final String fieldName) {
        return isDisplayed(findByXpath(String.format(INVALID_URL, fieldName)));
    }
    ...
    public void setDataExceedingTextLimit(final String fieldName) {
        send(getTextFieldWebPageElement(fieldName), DATA_FAKER.getDataExceedingTextLimit());
    }
