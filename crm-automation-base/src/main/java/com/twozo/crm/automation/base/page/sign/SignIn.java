package com.twozo.crm.automation.base.page.sign;

import com.twozo.crm.automation.base.page.BasePage;
import com.twozo.crm.automation.base.page.homepage.HomePage;
import com.twozo.crm.automation.base.page.deal.DealPage;
import com.twozo.crm.automation.base.page.xpath.AttributeName;
import com.twozo.crm.automation.base.page.xpath.TagName;
...
//        }
    ...
    public DealPage getDeal() {
        return DealPage.getInstance(getWebAutomationDriver());
    }

    public SignUp getSignUp() {
        return SignUp.getInstance(getWebAutomationDriver());
    }

    public WebPageElement getTwozoLogo() {
        return findByXpath("(//img[@alt='twozo'])[1]");
    }
    ...
    public HomePage signIn(final String email, final String password) {
        ...
        return HomePage.getInstance(getWebAutomationDriver());
    }
